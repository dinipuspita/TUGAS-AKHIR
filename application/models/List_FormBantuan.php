...
class List_FormBantuan extends CI_Model {
	...
	{
		$query = $this->db->query("Select * from pengenalan_tempat as a join penduduk as b on a.NIK=b.NIK");
...
// Tampil Data Detail
		public function getTampilKepemilikanAsetById($id)
	{
		$query = $this->db->query("Select * from kepemilikan_aset where NIK='$id'");
		return $query->result_array();
	}
	public function getTampilPengenalanTempatById($id)
	{
		$query = $this->db->query("Select * from pengenalan_tempat where NIK='$id'");
		return $query->result_array();
	}
	public function getTampilKeteranganPengesahanById($id)
	{
		$query = $this->db->query("Select * from keterangan_pengesahan where NIK='$id'");
		return $query->result_array();
	}
	public function getTampilKeteranganSosialEkonomiById($id)
	{
		$query = $this->db->query("Select * from keterangan_sosial_ekonomi where NIK='$id'");
		return $query->result_array();
	}
	public function getTampilKeteranganPerumahanById($id)
	{
