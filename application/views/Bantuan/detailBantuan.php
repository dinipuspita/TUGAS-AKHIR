...
<head>
    ...
    <title>Bantuan Sosial|Detail Data Bantuan</title>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <div class="breadcomb-wp">
                                    ...
                                    <div class="breadcomb-ctn">
                                        <h2>Data Bantuan</h2>
                                        <p>Data Bantuan<span class="bread-ntd"></span></p>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="animation-single-int">
                        <div class="animation-ctn-hd">
                            ...
                            <h2><?php echo $key['nama_bantuan'] ?></h2>
                                ...
                                Ketentuan   : <?php echo $key['syarat'] ?><br>

                                <a href="<?php echo base_url('index.php/listPenduduk/create/'.$key['id_bantuan'])?>" class="btn ant-nk-st bounce-ac"><span class="glyphicon glyphicon-list-alt"> Tambah</span></i></a><br>
