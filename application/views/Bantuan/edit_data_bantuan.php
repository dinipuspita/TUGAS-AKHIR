                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <div class="breadcomb-wp">
                                    ...
                                    <div class="breadcomb-ctn">
                                        ...
                                        <p>Edit Data Bantuan Sosial <span class="bread-ntd"></span></p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                <div class="form-group ic-cmp-int">
                                    ...
                                    <div class="nk-int-st">
                                      <input type="text" class="form-control" id="keterangan_bantuan" name="keterangan_bantuan" placeholder="Isi Kriteria" value="<?php echo $jenis_bantuan[0]->keterangan_bantuan?>">
                                    </div>
                                </div>
                           </div>
