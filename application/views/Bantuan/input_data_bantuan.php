...
<head>
    ...
    <title>Bantuan Sosial|Input Data Bantuan</title>
...
<body>
   ...
   <div class="breadcomb-area">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <div class="breadcomb-wp">
                                    ...
                                    <div class="breadcomb-ctn">
                                        ...
                                        <p>Data Bantuan Sosial<span class="bread-ntd"></span></p>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <?php echo form_open('ListBantuan/create'); ?> 
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                <div class="form-group ic-cmp-int">
                                    ...
                                    <div class="nk-int-st">
                                        <input type="text" class="form-control" id="nama_bantuan" name="nama_bantuan" placeholder="Nama bantuan">
                                    </div>
                                </div>
                            </div>
                             <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                <div class="form-group ic-cmp-int">
                                    ...
                                    <div class="nk-int-st">
                                        <input type="text" class="form-control" id="syarat" name="syarat" placeholder="Syarat / Ketentuan">
                                    </div>
                                </div>
                            </div>
                             <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                ...
                                <div class="bootstrap-select fm-cmp-mg">
                                        <select name="fk_kategori" class="selectpicker">
                                        <option value="">Pilih Ketegori Bantuan</option>
                                            <?php foreach ($kategori_bantuan as $data ){ ?>
