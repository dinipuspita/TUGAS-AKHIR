         ...
         echo validation_errors();
            $id = 1;
                ...
                <?php foreach ($last as $key){
                    $id = $key['id_jenis_bantuan']+1;                    
                }
                 ?>               

                <div class="form-group">
                    <input type="hidden" class="form-control" id="id_jenis_bantuan" name="id_jenis_bantuan" value="<?php echo $id ?>">
                </div>
                        ...
                        <div class="row">
                          ...
                          <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                <div class="form-group ic-cmp-int">
                                    ...
                                    <div class="nk-int-st">
                                        <input type="text" class="form-control" id="isi_kriteria" name="isi_kriteria" placeholder="Isi Kriteria">
                                    </div>
                                </div>
                            </div>
                          </div>
