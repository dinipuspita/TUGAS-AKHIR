...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <br>
          ...
          <!-- Sidebar - Brand -->
      <a class="sidebar-brand d-flex align-items-center justify-content-center"   a href="<?php echo base_url('index.php/ListBantuan/create')?>"</a></td>
 ...
 -->
        ...
        <div class="sidebar-brand-text mx-3"><img src="<?php echo base_url() ?>assets/img/satu.png" width="50px" height="55px"   a href="<?php echo base_url('index.php/ListBantuan/create')?>"</a></td></div>
 ...
 <div class="breadcomb-area">
      ...
      <?php echo form_open_multipart('ListBantuan/create'); ?> 
