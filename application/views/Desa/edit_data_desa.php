...
<body id="page-top">
 ...
 -->
       ...
       <h3><p class="h3 mb-2 text-gray-800">Edit Data Desa Kota Batu</a></p></h3>
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
             ...
             <?php echo form_open('listDesa/update/'.$this->uri->segment(3)); 
        ?>
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                <div class="form-group ic-cmp-int">
                                    ...
                                    <div class="nk-int-st">
                                        <input type="text" class="form-control" id="nama_desa" name="nama_desa" placeholder="Nama Desa" value="<?php echo $desa[0]->nama_desa?>">
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                <div class="form-group ic-cmp-int">
                                    ...
                                    <div class="nk-int-st">
                                        <input type="text" class="form-control" id="alamat" name="alamat" placeholder="Alamat" value="<?php echo $desa[0]->alamat?>">
                                    </div>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                <div class="form-group ic-cmp-int">
                                    <div class="form-ic-cmp">
                                        ...
                                        <div class="nk-int-st">
                                        <input type="text" class="form-control" id="no_telepon" name="no_telepon" placeholder="No Telepon" value="<?php echo $desa[0]->no_telepon?>">
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                <div class="form-group ic-cmp-int">
                                    <div class="form-ic-cmp">
                                        <i class="notika-icon notika-edit"></i>
                                         ...
                                         <div class="nk-int-st">
                                        <input type="text" class="form-control" id="kode_pos" name="kode_pos" placeholder="Nama Desa" value="<?php echo $desa[0]->kode_pos?>">
                                    </div>
                                </div>
                            </div>
                     <!--    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
