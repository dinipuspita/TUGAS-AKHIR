...
<body id="page-top">
 ...
 <div class="breadcomb-area">
      ...
      <?php echo form_open_multipart('ListFormBantuan/create'); ?> 
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                             ...
                             <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                <div class="form-group ic-cmp-int">
                                    ...
                                    <div class="nk-int-st">
                                        <input type="text" class="form-control" id="nama_sls" name="nama_sls" placeholder="Nama SLS" readonly required autofocus />
                                    </div>
                                </div>
                            </div>
                              <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                <div class="form-group ic-cmp-int">
                                    ...
                                    <div class="nk-int-st">
                                        <input type="text" class="form-control" id="alamat" name="alamat" placeholder="Alamat" readonly required autofocus />
                                    </div>
                                </div>
                            </div>
                        </div>
                       ...
                       <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                           ...
                           <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                            ...
                            <select class="selectpicker" name="tempat_PAT">
                                          <option value="">-----Tempat Pembuangan Air Tinja-----</option>
                          ...
                          <div class="row">
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                <div class="form-group ic-cmp-int">
                                   ...
                                   <select class="selectpicker" name="hub_kepala_keluarga">
                  ...
                  <div class="row">
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                <div class="form-group ic-cmp-int">
                                   ...
                                   <select class="selectpicker" name="partisipasi_sekolah">
                                ...
                                <div class="form-group ic-cmp-int">
                                    ...
                                    <select class="selectpicker" name="jenjang_pendidikan">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                <div class="form-group ic-cmp-int">
                                    <div class="form-ic-cmp">
                                      ...
                                      <div class="nk-int-st">
                                        <input type="text" class="form-control" id="kelas_tertinggi" name="kelas_tertinggi" placeholder="Kelas Tertinggi" required autofocus />
                                    </div>
                                </div>
                            </div>
                               ...
                               <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                <div class="form-group ic-cmp-int">
                                    ...
                                    <select class="selectpicker" name="ijazah_tertinggi">
                                          <option value="">-----Ijazah Tertinggi-----</option>
