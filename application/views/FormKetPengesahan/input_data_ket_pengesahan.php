...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <br>
            ...
            <!-- Sidebar - Brand -->
      <a class="sidebar-brand d-flex align-items-center justify-content-center"   a href="<?php echo base_url('index.php/ListKeteranganPengesahan/create')?>"</a></td>
 ...
 -->
        ...
        <div class="sidebar-brand-text mx-3"><img src="<?php echo base_url() ?>assets/img/satu.png" width="50px" height="55px"   a href="<?php echo base_url('index.php/ListKeteranganPengesahan/create')?>"</a></td></div>
              ...
              <div class="card shadow mb-4">
               <!--  <div class="card-header py-3"> -->
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Keterangan Petugas dan Koresponden</h6>
...
<!-- 
                                 ...
                                 <font color="red"><i><option value="">*Hasil Pemeriksan</option></i></font>
                                   <div class="bootstrap-select fm-cmp-mg">
                                      <select class="form-control" name="hasil_pemeriksaan">
                                          <option value="">-----Pilih-----</option>
                                                <option value="Selesai diverivali">Selesai diverivali</option>
                                                <option value="Rumah Tangga Tidak ditemukan">Rumah Tangga Tidak ditemukan</option>
                                                <option value="Rumah Tangga/Bangunan Sensus Sudah Tidak Ada">Rumah Tangga/Bangunan Sensus Sudah Tidak Ada</option>
                                                <option value="Bagian dari Rumah Tangga Sesuai Prelist">Bagian dari Rumah Tangga Sesuai Prelist</option>
                                            </optgroup>
                                        </select>
                                    </div>
                        ...
                        <!-- <div class="row">
                            ...
                            <button type="submit" class="btn btn-primary">Submit <span class="glyphicon glyphicon-ok"></span>
                                 ...
                                 <a href="<?php echo base_url('index.php/ListPengenalantempat/create')?>"class="btn glyphicon glyphicon-chevron-left"></a></td>
                              <a href="<?php echo base_url('index.php/ListKeteranganPerumahan/create')?>"class="btn glyphicon glyphicon-chevron-right"></a></td>
                        </center>
                    </div>
                </div>
            </div>
