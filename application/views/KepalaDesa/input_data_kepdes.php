...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <br>
           ...
           <!-- Sidebar - Brand -->
      <a class="sidebar-brand d-flex align-items-center justify-content-center"   a href="<?php echo base_url('index.php/ListKepalaDesa/create')?>"</a></td>
 ...
 -->
        ...
        <div class="sidebar-brand-text mx-3"><img src="<?php echo base_url() ?>assets/img/satu.png" width="50px" height="55px"   a href="<?php echo base_url('index.php/ListKepalaDesa/create')?>"</a></td></div>
 ...
 <div class="breadcomb-area">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <div class="breadcomb-wp">
                                    ...
                                    <div class="breadcomb-ctn">
                                        <h2>Tambah Kepala Desa Kota Batu</h2>
                                        <p>Data Kepala Desa Kota Batu <span class="bread-ntd"></span></p>
                                    </div>
                                </div>
                            </div>
    ...
    <div class="card-body">
     <?php echo form_open('ListKepalaDesa/create'); ?> 
                           ...
                           <div class="row">
                              <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                <div class="form-group ic-cmp-int">
                                    ...
                                    <div class="nk-int-st">
                                        <input type="text" class="form-control" id="nama_kepala_desa" name="nama_kepala_desa" placeholder="Nama Kepala Desa" required autofocus />
                                    </div>
                                </div>
                            </div>
                           <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
