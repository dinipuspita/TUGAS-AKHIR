                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <div class="breadcomb-wp">
                                    ...
                                    <div class="breadcomb-ctn">
                                        <h2>Edit Data Kriteria Bantuan Sosial Masyarakat</h2>
                                        <p>Edit Data Kriteria Bantuan Sosial Masyarakat Kota Batu<span class="bread-ntd"></span></p>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary"Data Kriteria Penerima Bantuan</h6>
            </div>
            <div class="card-body">
