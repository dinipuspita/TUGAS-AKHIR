        ...
        <div class="container">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <div class="breadcomb-wp">
                                    ...
                                    <div class="breadcomb-ctn">
                                        <h2>Tambah Data Kriteria Bantuan Sosial </h2>
                                        <p>Tambah Data Kriteria Bantuan Sosial <span class="bread-ntd"></span></p>
                                    </div>
                                </div>
                            </div>
          ...
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Data Kriteria Bantuan Sosial</h6>
            </div>
            <div class="card-body">

      <?php echo form_open_multipart('ListKriteriaBantuan/create'); ?> 
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="form-element-list">
                        <div class="basic-tb-hd">
                            <h2>Data Kriteria Bantuan Sosial</h2><br>
                        <div class="row">
