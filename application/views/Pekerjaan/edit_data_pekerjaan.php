                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="form-element-list">
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                <div class="form-group ic-cmp-int">
                                    ...
                                    <div class="nk-int-st">
                                        <input type="text" class="form-control" id="nama_pekerjaan" name="nama_pekerjaan" placeholder="Nama Pekerjaan" value="<?php echo $pekerjaan[0]->nama_pekerjaan?>">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <center>
                            ...
                            <a href="<?php echo base_url('index.php/ListPekerjaan')?>"class="btn btn-danger">Back</a></td>
                        </center>
                    <br>
                                 </div>
                              </div>
