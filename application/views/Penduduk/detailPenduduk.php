      ...
      <li class="nav-item">
        ...
        <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href='<?php echo base_url("index.php/Registrasi/create"); ?>'>Registrasi AKun Desa</a>
          </div>
        </div>
      </li>
      <li class="nav-item">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <div class="breadcomb-wp">
                                    ...
                                    <div class="breadcomb-ctn">
                                        ...
                                        <p>Detail Data Penduduk Kurang Mampu<span class="bread-ntd"></span></p>
                                    </div>
                                </div>
                            </div>
                        </div>
...
<tr>                     
<th>Tempat Lahir </th>      <td><?php echo $key['tempat_lahir'] ?>  </td><br>
<tr>                             
<th>Tanggal Lahir</th>      <td><?php echo $key['tanggal_lahir'] ?> </td><br>     
<tr>                           
<th>Jenis Kelamin</th>      <td><?php echo $key['jenis_kelamin'] ?> </td><br>
<tr> 
<th>Agama        </th>      <td><?php echo $key['agama'] ?>         </td><br>
<tr>     
...
<tr>     
<th>Alamat       </th>      <td><?php echo $key['alamat'] ?>        </td><br>
<tr>     
<th>RT           </th>      <td><?php echo $key['RT'] ?>            </td><br>
<tr>     
...
<?php  } ?>                                                                                      
    ...
    <center>
        <a href="<?php echo base_url('index.php/ListPenduduk')?>"class="btn btn-danger">Back</a>
</center>
