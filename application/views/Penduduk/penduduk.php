                                    ...
                                    <tbody>
                                         ...
                                         <?php if($key['level'] == '2') { ?> 
                                          ...
                                          <td>
                                            ...
                                            <a href="<?php echo base_url('index.php/ListPenduduk/tampilGroup/' .$key['NO_KK'])?>" class="btn btn-primary">Detail Keluarga <span class="glyphicon glyphicon-th-list"></span></a>
