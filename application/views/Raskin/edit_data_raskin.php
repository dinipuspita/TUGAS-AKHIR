...
<body>
    <!--[if lt IE 8]>
            <p class="browserupgrade">You are using an <strong>outdated</strong> browser. Please <a href="<?php echo base_url() ?>assets/<?php echo base_url() ?>assets/http://browsehappy.com/">upgrade your browser</a> to improve your experience.</p>
        <![endif]-->
   ...
   <div class="breadcomb-area">
     ...
     <?php echo form_open('Raskin/update/'.$this->uri->segment(3)); 
        ?>
                    ...
                    <div class="form-element-list">
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                <div class="form-group ic-cmp-int">
                                    ...
                                    <div class="nk-int-st">
                                        <input type="text" class="form-control" id="tanggungan_keluarga" name="tanggungan_keluarga" placeholder="Jumlah Tanggungan" value="<?php echo $raskin[0]->tanggungan_keluarga?>">
                                    </div>
                                </div>
                            </div>
                           ...
                           <div class="nk-int-mk sl-dp-mn sm-res-mg-t-10">
                                ...
                                <div class="bootstrap-select fm-cmp-mg">
                                        <select name="fk_penduduk" class="selectpicker">
                                        <option value="">Pilih Penduduk</option>
                                            <?php foreach ($penduduk as $data ){ ?>
                                            <option value="<?php echo $data['id_penduduk']; ?>"><?php echo $data['id_penduduk'] ?> | <?php echo $data['nama_penduduk']; ?>
                                         </option>
                                             <?php } ?>
                                    </select>
                              </div>
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                           <div class="nk-int-mk sl-dp-mn sm-res-mg-t-10">
                                ...
                                <div class="bootstrap-select fm-cmp-mg">
                                        <select name="id_bantuan" class="selectpicker">
                                        <option value="">Pilih Bantuan</option>
                                            
                                            <?php foreach ($bantuan as $data ){ ?>
                                            <option value="<?php echo $data['id_bantuan']; ?>"><?php echo $data['id_bantuan'] ?> | <?php echo $data['nama_bantuan']; ?>
                                         </option>
                                             <?php } ?>
                                    </select>
                              </div>
                        ...
                        <center>
                            ...
                            <a href="<?php echo base_url('index.php/Raskin')?>"class="btn btn-danger">Back</a></td>
                        </center>
                    </div>
                </div>
            </div>
