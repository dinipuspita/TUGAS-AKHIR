...
<body>
   ...
   <div class="breadcomb-area">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <div class="breadcomb-wp">
                                    ...
                                    <div class="breadcomb-ctn">
                                        <h2>Data Penduduk Penerima Bantuan</h2>
                                        <p>Data Penduduk Penerima Bantuan Sosial<span class="bread-ntd"></span></p>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <?php echo form_open('Raskin/create'); ?> 
                        ...
                        <div class="basic-tb-hd">
                            ...
                            <div class="row">
                                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                    ...
                                    <div class="nk-int-st">
                                       <input type="text" class="form-control" id="tanggungan_keluarga" name="tanggungan_keluarga" placeholder="Jumlah Tanggungan Keluarga">
                                    </div>
                                </div>
                            </div>
                           <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                            ...
                            <!-- <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                ...
                                <div class="bootstrap-select fm-cmp-mg">
                                        <select name="fk_bantuan" class="selectpicker">
