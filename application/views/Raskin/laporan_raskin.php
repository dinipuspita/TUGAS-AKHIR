...
<body>
   ...
   <div class="breadcomb-area">
    ...
    <?php echo form_open('Raskin/report'); ?> 
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="form-element-list">
                        <div class="basic-tb-hd">
                            <h2>Print Laporan Penerima Raskin</h2><br>
                            <div class="row">
                           <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                <div class="nk-int-mk sl-dp-mn sm-res-mg-t-10">
                                </div>
                                <div class="bootstrap-select fm-cmp-mg">
                                        <select name="id_desa" class="selectpicker">
                                        <option value="">Pilih Desa</option>
                                            <?php foreach ($desa as $data ){ ?>
                                            <option value="<?php echo $data['id_desa']; ?>"><?php echo $data['id_desa'] ?> | <?php echo $data['nama_desa']; ?>
                                         </option>
                                             <?php } ?>
                                    </select>
                                    </div>
