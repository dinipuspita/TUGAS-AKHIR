                         ...
                         <div class="row">                     
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                ...
                                <div class="form-group ic-cmp-int">
                                    ...
                                    <div class="nk-int-st"><input type="date" class="form-control" id="tanggal_surat" name="tanggal_surat" placeholder="Tanggal Surat" value="<?php echo $surat[0]->tanggal_surat?>">
                                    </div>
                                </div>
                            </div>
                       </div>   
                       <div class="row">                     
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                ...
                                <div class="form-group ic-cmp-int">
                                    ...
                                    <div class="nk-int-st"><input type="text" class="form-control" id="keterangan" name="keterangan" placeholder="Keterangan Surat" value="<?php echo $surat[0]->keterangan?>">
                                    </div>
                                </div>
                            </div>
                       </div>   
