...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <!-- Sidebar - Brand -->
      <a class="sidebar-brand d-flex align-items-center justify-content-center" a href="<?php echo base_url('index.php/forgotPassword')?>"</a></td>
        <div class="sidebar-brand-icon rotate-n-15">
       
        </div>
        <div class="sidebar-brand-text mx-3"><img src="<?php echo base_url() ?>assets/img/satu.png" width="50px" height="55px" a href="<?php echo base_url('index.php/forgotPassword')?>"</a></td></div>
 ...
 -->
   ...
   <!--    <hr class="sidebar-divider my-0"> -->
     ...
     <!--  <li class="nav-item active">
        <a class="nav-link" href='<?php echo base_url("index.php/forgotPassword"); ?>'>
              ...
              <div class="card shadow mb-4">
               <!--  <div class="card-header py-3"> -->
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Pemberitahuan Lupa Passwod</h6>
